---
title: <font size="5">**Proprioceptive precision and the degree of visuo-proprioceptive discrepancy do not influence the strength of rubber hand illusion**</font> 
...
7. The irrelevance of distance and proprioceptive accuracy for electrodermal activity [S7](#S7) </font>
...
barplot(BFs, border = NA, space = 0.6, log = "x", horiz = T, xlim = c(0.033,3), xaxt="n", xlab = "Bayes Factor", col = c("darkgoldenrod2", "darkgoldenrod2", rgb(0.46,0.62,0.18), rgb(0.46,0.62,0.18), alpha = 0.7) , cex.lab = 1.3, cex.axis = 1.5)
...
abline(v= 0.033, col=alpha(rgb(0.2,0.2,0.2), 0.6), lty = 2, lwd = 1)
abline(v= 0.1, col=alpha(rgb(0.2,0.2,0.2), 0.6), lty = 2, lwd = 1)
abline(v= 0.333, col=alpha(rgb(0.2,0.2,0.2), 0.6), lty = 2, lwd = 1)
abline(v = 1, col=alpha(rgb(0.2,0.2,0.2), 0.6), lty = 2, lwd = 1)  
abline(v = 3, col=alpha(rgb(0.2,0.2,0.2), 0.6), lty = 2, lwd = 1)  
